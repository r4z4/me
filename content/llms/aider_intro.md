...
One thing is quire obvious from the little experiments that I have done so far with it, though, and that is that it will take time. My first attempt at creating a file was met with a good ten minutes of pure confusion as where the changes where and why it was not working for this one feature. Searches of “aider not creating file” etc caused more confusion. Well, turn out you just need to always be explicit with the file paths. Completely obvious and  I was slightly embarrassed for myself, until I realized that this is just one tiny instance of a much larger pattern – just needing to adapt to his new workflow.
